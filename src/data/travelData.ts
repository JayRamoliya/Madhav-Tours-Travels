...
export const COMPANY_DETAILS = {
  ...
  whatsapp: "968238927009",
  whatsappDisplay: "+96 82389 27009",
...
export const POPULAR_DESTINATIONS: TourPackage[] = [
  {
    ...
    highlights: [
      "Helicopter & doli coordination",
      "Comfortable deluxe stays along holy route",
      "Experienced hill chauffeurs",
      "Sattvik food arrangements",
    ],
    inclusions: [
      "Private Vehicle",
      "Deluxe Stays",
      "Breakfast & Dinner",
      "VIP Darshan Guidance",
    ],
  ...
  },
  {
    ...
    highlights: [
      "Private luxury shikara ride",
      "Stay in carved cedar wood houseboats",
  ...
  },
  {
    ...
    tagline:
      "Misty tea plantations, Ayurvedic rejuvenation & backwater cruises",
    highlights: [
      "Private traditional premium houseboat with chef",
      "Sprawling tea garden visits",
      "Spice plantation aroma tour",
  ...
  },
  {
    ...
    highlights: [
      "Stay in authentic heritage havelis",
      "Sunset camel safari & folk music in Sam dunes",
      "Boat cruise on Lake Pichola",
      "Amber Fort elephant/jeep access",
    ],
    inclusions: [
      "Heritage Stays",
      "Private Luxury Sedan/SUV",
      "Desert Camp Stay",
      "Royal Breakfasts",
    ],
  ...
  },
  {
    ...
    tagline:
      "Private beachfront villas, Portuguese quarters & luxury catamarans",
    highlights: [
      "5-Star beach resort stays",
      "Private sunset yacht charter",
      "Fontainhas Latin quarter heritage walk",
      "Water sport activities coordination",
    ],
    inclusions: [
      "5-Star Beach Resort",
      "Airport Transfers",
  ...
  },
  {
    ...
    tagline:
      "Burj Khalifa VIP lounge, luxury desert safari & Marina yacht dinner",
    highlights: [
      "Burj Khalifa 124th & 148th floor access",
      "VIP desert camp with barbecue & stargazing",
      "Sheikh Zayed Grand Mosque private tour",
      "Dhow luxury glass cruise",
    ],
    inclusions: [
      "4/5-Star City Hotel",
      "Private Airport Transfers",
      "Tourist Visa Support",
      "Desert Safari & Marina Cruise",
    ],
  ...
  },
  {
    ...
    tagline:
      "Private infinity pool villas, lush rice terraces & sacred temples",
    highlights: [
      "Private pool villa in Ubud & beach resort in Seminyak",
      "Nusa Penida Kelingking beach private speedboat tour",
      "Balinese spa & flower bath experience",
      "Tanah Lot sunset temple view",
    ],
    inclusions: [
      "Private Pool Villa",
      "Dedicated Chauffeur & Car",
      "Nusa Penida Tour",
      "Daily Breakfast",
    ],
